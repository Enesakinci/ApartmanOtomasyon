    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Kömür ücreti kaydet</div>
            </div>
            <form action="" method="get" name="frm1">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="aidatUcret">Kömür Ücreti</label>
                        <input type="text" class="form-control" name="komurUcret" placeholder="Ücret">
